...
@Component({
  ...
  templateUrl: './scheduled-cancel-dialog.component.html',
  styleUrls: ['./scheduled-cancel-dialog.component.scss'],
  standalone: true,
  imports: [
    SharedModule,
...
export class ScheduledCancelDialogComponent implements OnInit, OnDestroy {
  private $unsub = new Subject();

  constructor(
    private store$: Store<AppState>,
    private bottomSheetRef: MatBottomSheetRef<ScheduledCancelDialogComponent>) {
  }
