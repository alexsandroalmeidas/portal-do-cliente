...
@Component({
  selector: 'app-scheduled-active-cancel-dialog',
  templateUrl: './scheduled-active-cancel-dialog.component.html',
  styleUrls: ['./scheduled-active-cancel-dialog.component.scss'],
  standalone: true,
  imports: [
    SharedModule,
...
export class ScheduledActiveCancelDialogComponent implements OnInit, OnDestroy {
  private $unsub = new Subject();

  constructor(
    private store$: Store<AppState>,
    private bottomSheetRef: MatBottomSheetRef<ScheduledActiveCancelDialogComponent>) {
  }
