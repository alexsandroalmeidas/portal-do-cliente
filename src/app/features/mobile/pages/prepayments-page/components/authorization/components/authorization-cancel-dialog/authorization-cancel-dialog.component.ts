...
@Component({
  selector: 'app-authorization-cancel-dialog',
  templateUrl: './authorization-cancel-dialog.component.html',
  styleUrls: ['./authorization-cancel-dialog.component.scss'],
  standalone: true,
  imports: [
    SharedModule,
...
export class AuthorizationCancelDialogComponent implements OnInit, OnDestroy {
  private $unsub = new Subject();

  constructor(
    private store$: Store<AppState>,
    private bottomSheetRef: MatBottomSheetRef<AuthorizationCancelDialogComponent>) {
  }
